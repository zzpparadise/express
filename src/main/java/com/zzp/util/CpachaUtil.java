...
public class CpachaUtil {
	 ...
	 */
	public BufferedImage generatorVCodeImage(String vcode, boolean drawline) throws NoSuchAlgorithmException{
		//������֤��ͼƬ
	 ...
	 * @throws NoSuchAlgorithmException 
	 */
	public BufferedImage generatorRotateVCodeImage(String vcode, boolean drawline) throws NoSuchAlgorithmException{
		//������֤��ͼƬ
	 ...
	 * @throws NoSuchAlgorithmException 
	 */
	public String generatorVCode() throws NoSuchAlgorithmException{
		int len = code.length;
		Random ran = SecureRandom.getInstanceStrong();
	 ...
	 * @throws NoSuchAlgorithmException 
	 */
	private void drawDisturbLine(Graphics g) throws NoSuchAlgorithmException{
		Random ran = SecureRandom.getInstanceStrong();
	 ...
	 * @throws NoSuchAlgorithmException 
	 */
	private BufferedImage getRotateImage(char c) throws NoSuchAlgorithmException{
	 ...
	 * @throws NoSuchAlgorithmException 
	 */
	private Color getRandomColor() throws NoSuchAlgorithmException{
		Random ran = SecureRandom.getInstanceStrong();
